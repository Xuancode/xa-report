...
export default {
  ...
  mounted() {
    this.ready(function() {
      ...
      XAppJSBridge.call('showOptionMenu', {}, function(e) {
        console.log(e);
      });
  ...
  methods: {
    ...
    getIos() {
      ...
      if (ua.match(/iPhone\sOS/i) == "iphone os") {} else {}
    },
    //获取图片或者拍照
    // getImg(event) {
    //   var _this = this;
...
.bigDiv {
  ...
  .content {
    width: 100%;
    background-color: #FFF;
    padding: 0.15rem 0.28rem; // box-shadow: 0 0.15rem 0 rgba(220,220,220,0.6);
    position: relative;
  }
  .text {
    width: 96%;
    ...
    outline: none;
    resize: none; // box-shadow: 0 0 0.05rem #D3D3D3;
  }
  .imgDiv {
    height: 1.05rem;
    width: 100%;
  ...
  .userMessage {
    ...
    .user {
      height: 0.7rem;
      width: 100%;
      border-bottom: 0.03rem solid #D3D3D3; // box-shadow: 0 0.02rem 0.02rem #D3D3D3;
      line-height: 0.7rem;
      padding: 0 0.2rem;
      position: relative;
      span {
